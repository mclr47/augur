<template>
  <nav class="tabs">
        <ul>
          ...
          <li :class="{ active: (currentTab == 'experimental') }"><a href="#" @click="changeTab" data-value="experimental">Experimental</a></li><li :class="{ active: (currentTab == 'test') }"><a href="#" @click="changeTab" data-value="test">Test</a></li>  
